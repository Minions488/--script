--[[
  ...
  Thoi gian tao: 14:15:42 16/8/2026
...
_AT.hash = function(s)
  local h = 2166136261
  for i = 1, #s do
    h = bit32.bxor(h * 16777619, string.byte(s, i))
  end
  return h
end
_AT.verify = function(expected)
  if _AT.hash("") ~= expected then
...
--[[
  Generated: 2026-08-16T06:15:42.182Z
]]--
...
_VM.locals = {
  ...
  [555] = "ExtraTab",
  [556] = "CombatSection",
  [557] = "AutoAttackEnabled",
  [558] = "AutoAttackConnection",
  [559] = "_tmp_obj_925",
  [560] = "handle",
  [561] = "touch",
  [562] = "otherChars",
  ...
  [580] = "_tmp_obj_5018",
  [581] = "_tmp_obj_4591",
  [582] = "StealBackpackEnabled",
  [583] = "StealBackpackThread",
  [584] = "_tmp_obj_6140",
  [585] = "_tmp_obj_7830",
  [586] = "UtilSection3",
  [587] = "_tmp_obj_3679",
  ...
  [609] = "ChamsEnabled",
  [610] = "ChamsFillColor",
  [611] = "ChamsTransparency",
  [612] = "ChamsOutlineColor",
  [613] = "ChamsOutlineTransparency",
  [614] = "TeamCheck",
  [615] = "ShowTeam",
  [616] = "MaxDistance",
  [617] = "AllyColor",
...
_VM.bytecode = {
  ...
  -- RAW: end)
  {op=5,a=568,bx=304},
  {op=10,a=568,b=568,c=305},
  {op=27,a=568,b=3,c=1},
  {op=21,sbx=0},
  {op=25,a=0,c=0},
  {op=21,sbx=0},
  {op=5,a=569,bx=817},
  {op=10,a=569,b=569,c=306},
  {op=27,a=569,b=2,c=1},
  {op=1,a=558,bx=123},
  {op=6,a=558,bx=817},
  {op=29,a=0,b=1},
...
-- Watermark: LSU-156133-1786860942236
-- Fingerprint: MC43ODUzMDM2MTg1
