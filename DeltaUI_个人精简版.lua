--[[
  DeltaUI 个人精简续更版（非官方）
  - 已关闭：远程 UI 版本检查、原作者云模块 model.json
  - 保留：主界面、编辑器、设置、悬浮球、本地功能；ScriptBlox 仍走公共 API
  - 原项目作者已停更；本文件仅供个人使用与学习
]]
...
local translations = {
    ...
    ai_model_provider = {en = "AI Model", zh = "AI 模型", ko = "AI 모델", ja = "AIモデル"},
    ai_model_provider_desc = {en = "Switch between OpenRouter free and TokenRouter limited-free models", zh = "在 OpenRouter 免费模型与 TokenRouter 限免模型之间切换", ko = "OpenRouter 무료 / TokenRouter 한시 무료 전환", ja = "OpenRouter無料とTokenRouter期間限定無料を切替"},
    ai_model_openrouter = {en = "OpenRouter Free (Nex Mini)", zh = "OpenRouter 免费 (Nex Mini)", ko = "OpenRouter 무료 (Nex Mini)", ja = "OpenRouter無料 (Nex Mini)"},
    ai_model_tokenrouter = {en = "TokenRouter Limited Free (GLM-5.3)", zh = "TokenRouter 限免 (GLM-5.3)", ko = "TokenRouter 한시무료 (GLM-5.3)", ja = "TokenRouter期間限定 (GLM-5.3)"},
    ...
    detailed_errors = {en = "Detailed Errors", zh = "更详细的错误信息", ko = "상세 오류 정보", ja = "詳細なエラー情報"},
    detailed_errors_desc = {en = "Show additional error context and source info", zh = "显示额外的错误上下文和来源信息", ko = "추가 오류 컨텍스트 및 소스 정보 표시", ja = "追加のエラーコンテキストとソース情報を表示"},
    scriptblox_search = {en = "Search scripts...", zh = "搜索脚本...", ko = "스크립트 검색...", ja = "スクリプトを検索..."},
    script_search_source = {en = "Script search source", zh = "搜索脚本来源", ko = "스크립트 검색 소스", ja = "スクリプト検索元"},
    script_sort = {en = "Sort scripts by", zh = "脚本排序方式", ko = "스크립트 정렬", ja = "スクリプト並び替え"},
    script_sort_desc = {en = "Views / date / likes, ascending or descending", zh = "按浏览、日期、点赞，升序或倒序", ko = "조회·날짜·좋아요, 오름/내림차순", ja = "閲覧・日付・いいね、昇順/降順"},
    sort_views_desc = {en = "Views ↓", zh = "浏览量 ↓", ko = "조회 ↓", ja = "閲覧 ↓"},
    sort_views_asc = {en = "Views ↑", zh = "浏览量 ↑", ko = "조회 ↑", ja = "閲覧 ↑"},
    sort_date_desc = {en = "Newest", zh = "最新发布", ko = "최신순", ja = "新しい順"},
    sort_date_asc = {en = "Oldest", zh = "最早发布", ko = "오래된순", ja = "古い順"},
    sort_likes_desc = {en = "Likes ↓", zh = "点赞 ↓", ko = "좋아요 ↓", ja = "いいね ↓"},
    script_search_source_desc = {en = "Choose ScriptBlox or RScripts for cloud search", zh = "云搜索使用 ScriptBlox 或 RScripts", ko = "클라우드 검색에 ScriptBlox 또는 RScripts 사용", ja = "クラウド検索にScriptBloxまたはRScriptsを使用"},
    source_scriptblox = {en = "ScriptBlox", zh = "ScriptBlox", ko = "ScriptBlox", ja = "ScriptBlox"},
    source_rscripts = {en = "RScripts", zh = "RScripts", ko = "RScripts", ja = "RScripts"},
    scriptblox_no_results = {en = "No scripts found", zh = "未找到脚本", ko = "스크립트를 찾을 수 없음", ja = "スクリプトが見つかりません"},
    load_more_scripts = {en = "Load more", zh = "加载更多", ko = "더 불러오기", ja = "もっと読み込む"},
    loading_more = {en = "Loading...", zh = "加载中...", ko = "로딩 중...", ja = "読み込み中..."},
    no_more_scripts = {en = "No more scripts", zh = "没有更多了", ko = "더 없음", ja = "これ以上ありません"},
    scriptblox_maintenance = {en = "ScriptBlox search is under maintenance. Showing trending instead.", zh = "ScriptBlox 搜索维护中，已改为显示热门脚本", ko = "ScriptBlox 검색 점검 중, 인기 스크립트 표시", ja = "ScriptBlox検索メンテナンス中。トレンドを表示"},
    scriptblox_network_fail = {en = "Failed to reach ScriptBlox (network)", zh = "无法连接 ScriptBlox（网络问题）", ko = "ScriptBlox 연결 실패", ja = "ScriptBloxに接続できません"},
    executes_label = {en = "Executes", zh = "次执行", ko = "실행", ja = "回実行"},
    ...
    likes_label = {en = "Likes", zh = "赞", ko = "좋아요", ja = "いいね"},
    key_required = {en = "KEY", zh = "需Key", ko = "KEY필요", ja = "KEY必要"},
    key_free = {en = "No Key", zh = "免Key", ko = "KEY없음", ja = "KEY不要"},
    published_label = {en = "Published", zh = "发布", ko = "게시", ja = "公開"},
    executes_na = {en = "Exec N/A", zh = "执行次数无", ko = "실행수 없음", ja = "実行数なし"},
...
-- 搜索框左侧，右侧留给「排序」+ 刷新
cloudSearchBox = create("Frame", {Position = UDim2.new(0, 12, 0, 8), Size = UDim2.new(1, -168, 0, 32), BackgroundColor3 = theme.surface, BackgroundTransparency = 0.25, BorderSizePixel = 0, ZIndex = 5})
...
-- 搜索栏旁：排序（不在设置里）
local SCRIPT_SORT_OPTIONS = {
    { id = "views_desc", labelKey = "sort_views_desc" },
    { id = "views_asc", labelKey = "sort_views_asc" },
    { id = "date_desc", labelKey = "sort_date_desc" },
    { id = "date_asc", labelKey = "sort_date_asc" },
    { id = "likes_desc", labelKey = "sort_likes_desc" },
}
local function scriptSortLabel(id)
    for _, o in ipairs(SCRIPT_SORT_OPTIONS) do
        if o.id == id then return t(o.labelKey) end
    end
    return t("sort_views_desc")
end
do
    local cfg0 = loadConfig()
    _G.__DeltaUI_scriptSort = cfg0.scriptSort or "views_desc"
end
cloudSortBtn = create("TextButton", {
...
corner(8, cloudSortBtn)
cloudSortBtn.Parent = cloudPage
cloudSortTxt = create("TextLabel", {
    Size = UDim2.new(1, -8, 1, 0),
    Position = UDim2.new(0, 4, 0, 0),
    BackgroundTransparency = 1,
    Text = scriptSortLabel(_G.__DeltaUI_scriptSort),
...
cloudSortTxt.Parent = cloudSortBtn

local cloudSortOpen = false
local cloudSortList = nil
cloudSortBtn.MouseButton1Click:Connect(function()
    if cloudSortOpen and cloudSortList then
        cloudSortList:Destroy()
        cloudSortList = nil
        cloudSortOpen = false
        return
    end
    cloudSortOpen = true
    local h = #SCRIPT_SORT_OPTIONS * 28
    cloudSortList = create("Frame", {
        Position = UDim2.new(1, -160, 0, 42),
        Size = UDim2.new(0, 114, 0, h),
        BackgroundColor3 = theme.surfaceLight or theme.surface,
        BackgroundTransparency = 0.1,
        BorderSizePixel = 0,
        ZIndex = 50,
        Parent = cloudPage,
    })
    corner(8, cloudSortList)
    for i, opt in ipairs(SCRIPT_SORT_OPTIONS) do
        local b = create("TextButton", {
            ...
            ZIndex = 51,
            Parent = cloudSortList,
        })
        b.MouseButton1Click:Connect(function()
            _G.__DeltaUI_scriptSort = opt.id
            local cfg = loadConfig()
            cfg.scriptSort = opt.id
            saveConfig(cfg)
            cloudSortTxt.Text = t(opt.labelKey)
            if cloudSortList then cloudSortList:Destroy() end
            cloudSortList = nil
            cloudSortOpen = false
            pcall(function()
...
-- 搜索脚本来源：ScriptBlox / RScripts
rowScriptSource = makeSettingRow("script_search_source", "script_search_source_desc", -1)
do
    local labels = { t("source_scriptblox"), t("source_rscripts") }
    local cfg0 = loadConfig()
    local defIdx = (cfg0.scriptSearchSource == "rscripts") and 2 or 1
    makeDropdown(rowScriptSource, labels, defIdx, function(val)
        local src = "scriptblox"
        if tostring(val):find("RScript", 1, true) or tostring(val):find("rscript", 1, true) then
            src = "rscripts"
        end
        local cfg = loadConfig()
        cfg.scriptSearchSource = src
        saveConfig(cfg)
        _G.__DeltaUI_scriptSearchSource = src
        pcall(function()
            ShowNotification(src == "rscripts" and "搜索源：RScripts" or "搜索源：ScriptBlox", 2)
        end)
        -- 立即按新源刷新列表
        pcall(function()
            if type(refreshScriptBloxList) == "function" and cloudSearchInput then
                refreshScriptBloxList(cloudSearchInput.Text)
            end
        end)
        return src
    end, "scriptSearchSource")
end
rowScriptSource.Parent = settingsScroll

-- AI 模型切换（OpenRouter 免费 / TokenRouter 限免）
rowAIModel = makeSettingRow("ai_model_provider", "ai_model_provider_desc", -1)
local aiModelLabels = {
    t("ai_model_openrouter"),
    t("ai_model_tokenrouter"),
}
local function onAIModelChange(val)
    local provider = "openrouter"
    if val == t("ai_model_tokenrouter") or tostring(val):find("TokenRouter", 1, true) or tostring(val):find("GLM", 1, true) then
        provider = "tokenrouter"
    end
    local cfg = loadConfig()
    cfg.aiProvider = provider
    saveConfig(cfg)
    if type(_G.__DeltaUI_applyAIProvider) == "function" then
        _G.__DeltaUI_applyAIProvider(provider)
    end
    pcall(function()
        ShowNotification(provider == "tokenrouter" and "已切换：TokenRouter GLM-5.3 限免" or "已切换：OpenRouter Nex Mini 免费", 2)
    end)
    return provider
end
-- defaultIndex: 1=openrouter, 2=tokenrouter；从配置恢复
do
    local cfg0 = loadConfig()
    local defIdx = (cfg0.aiProvider == "tokenrouter") and 2 or 1
    makeDropdown(rowAIModel, aiModelLabels, defIdx, onAIModelChange, "aiProvider")
end
rowAIModel.Parent = settingsScroll
            ...
            for _, log in ipairs(batch) do
                if log then
                    ...
                    entry.MouseButton1Click:Connect(function()
                        local txt = log.msg
                        local ok = false
                        if type(setclipboard) == "function" then ok = pcall(setclipboard, txt) end
                        if not ok and type(toclipboard) == "function" then ok = pcall(toclipboard, txt) end
                        if ok then
                            pcall(function() ShowNotification("已复制该条日志", 1.2) end)
                        else
                            pcall(function() ShowNotification("复制失败", 1.5) end)
                        end
                    end)
...
local wasaiCreateMessageContainer
...
local function wasaiExecuteLuaCode(code)
    ...
    -- wasaiLocalAIConfig 在文件后部才赋值；此处可能为 nil，必须兜底
    local cfg = (type(wasaiLocalAIConfig) == "table" and wasaiLocalAIConfig)
        or (type(_G.__DeltaUI_wasaiLocalAIConfig) == "table" and _G.__DeltaUI_wasaiLocalAIConfig)
        or {}
    local execTimeout = tonumber(cfg.executeTimeout) or 15
...
-- 导出执行函数，供代码卡片在作用域外调用
pcall(function() getgenv().__DeltaUI_wasaiExecuteLuaCode = wasaiExecuteLuaCode end)
_G.__DeltaUI_wasaiExecuteLuaCode = wasaiExecuteLuaCode
...
-- ===== AI 双通道：OpenRouter 免费 / TokenRouter 限免 =====
local WASAI_AI_PROVIDERS = {
    openrouter = {
        name = "OpenRouter 免费",
        endpoint = "https://openrouter.ai/api/v1/chat/completions",
        model = "nex-agi/nex-n2.5-mini:free",
        apiKey = "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",
        timeout = 60,
    ...
    tokenrouter = {
        ...
        apiKey = "sk-fCYhgPyF24RBfdeA368X8LQh0ay4ZWLcqhp9Jd6Eo2zeGkTs",
        timeout = 90,
        thinkingDisabled = false,
    },
}
...
local wasaiLocalAIConfig = {
    enabled = true,
    provider = "openrouter",
    endpoint = WASAI_AI_PROVIDERS.openrouter.endpoint,
    model = WASAI_AI_PROVIDERS.openrouter.model,
    apiKey = WASAI_AI_PROVIDERS.openrouter.apiKey,
    timeout = 60,
    thinkingDisabled = false,
    temperature = 0.72,
...
-- 供执行引擎 / 代码卡片安全读取
_G.__DeltaUI_wasaiLocalAIConfig = wasaiLocalAIConfig
pcall(function() getgenv().__DeltaUI_wasaiLocalAIConfig = wasaiLocalAIConfig end)

local function wasaiApplyAIProvider(providerId)
    providerId = tostring(providerId or "openrouter")
    local preset = WASAI_AI_PROVIDERS[providerId] or WASAI_AI_PROVIDERS.openrouter
    wasaiLocalAIConfig.provider = providerId
    wasaiLocalAIConfig.endpoint = preset.endpoint
    wasaiLocalAIConfig.model = preset.model
    wasaiLocalAIConfig.apiKey = preset.apiKey
    wasaiLocalAIConfig.timeout = preset.timeout or 60
    wasaiLocalAIConfig.thinkingDisabled = preset.thinkingDisabled and true or false
    _G.__DeltaUI_wasaiLocalAIConfig = wasaiLocalAIConfig
    pcall(function() getgenv().__DeltaUI_wasaiLocalAIConfig = wasaiLocalAIConfig end)
    pcall(function()
        print("[DeltaUI][AI] 当前通道: " .. tostring(preset.name) .. " | " .. tostring(preset.model))
    end)
end
_G.__DeltaUI_applyAIProvider = wasaiApplyAIProvider

-- 启动时按设置恢复
pcall(function()
    local cfg = loadConfig and loadConfig() or {}
    local pid = cfg.aiProvider or "openrouter"
    if WASAI_AI_PROVIDERS[pid] then
        wasaiApplyAIProvider(pid)
    end
end)
...
local function wasaiBuildSystemPrompt()
    return table.concat({
        "你是 AgentLess，DeltaUI 内的 Roblox Luau 助手，运行在客户端执行器环境中。",
        "目标：帮用户写/改/修可直接执行的 Roblox 本地脚本（LocalScript 逻辑），代码必须可在执行器里 loadstring 运行。",
        "",
        "【输出格式】",
        "1) 给用户可运行的代码时，必须使用 Markdown 代码块，且语言标为 lua：",
        "```lua",
        "-- 完整可运行代码",
        "```",
        "2) 不要用单独的 ## 符号；不要把代码和说明混在同一行。",
        "3) 说明文字简短；代码尽量完整、可直接点「执行」。",
        "4) 可用 **粗体** 强调关键点。",
        "",
        "【Roblox Luau 硬性规则——违反即为错误】",
        "- 计时用 os.clock() / time() / tick()，禁止 RunService.Heartbeat.Time（不存在）。",
        "- 跳跃状态是 Enum.HumanoidStateType.Jumping，不是 Jump。",
        "- 自动跳：落地再跳（FloorMaterial ~= Air），并加 cooldown；Character 可能 respawn，用 player.Character 或 CharacterAdded。",
        "- 获取服务用 game:GetService(\"Name\")；LocalPlayer 用 Players.LocalPlayer。",
        "- 不要写仅 Studio 插件 API；不要假设 ServerScript 在客户端能跑。",
        "- 不要编造不存在的 Roblox API；不确定就写「不确定」并给保守写法。",
        "",
        "【不要乱修 DeltaUI 本体】",
        "- 用户贴出的报错若栈里出现 wasaiExecuteLuaCode / DeltaUI / AgentLess / LocalScript 行号很大：",
        "  先判断是「用户脚本」还是「UI 工具内部」。",
        "- 若是工具内部错误：简要说明可能是 UI 问题，让用户更新 DeltaUI 或换执行方式，禁止要求重装整个 WASAI、禁止编造内部配置项名称糊弄用户。",
        "- 若是用户脚本错误：只改用户代码，给出修正后的完整代码块。",
        "",
        "【工具】",
        "可用：list_children、decompile、get_property、find_objects、execute_lua、读写输出文件等。",
        "仅在需要查实例/反编译/真正执行时才调用工具；普通写脚本直接给代码。",
        "回答简洁切题，不要长篇铺垫。",
        "禁止只回复「好的」「我知道了」「明白了」等空确认；每次必须给出实质内容或完整代码。",
    }, "\n")
end
...
-- 收集执行器可用的 HTTP 请求函数（按优先级尝试多个）
local function wasaiListHttpRequestFns()
    local list = {}
    local function add(fn, name)
        if type(fn) == "function" then
            list[#list + 1] = {fn = fn, name = name}
        end
    end
    add(syn and syn.request, "syn.request")
    add(http and http.request, "http.request")
    add(http_request, "http_request")
    add(request, "request")
    add(fluxus and fluxus.request, "fluxus.request")
    add(krnl and krnl.request, "krnl.request")
    return list
end

local function wasaiGetHttpRequestFn()
    local list = wasaiListHttpRequestFns()
    return list[1] and list[1].fn or nil
end

-- 更可读的网络错误说明（避免重复拼接）
local function wasaiExplainNetErr(err)
    local s = tostring(err or "")
    -- 已解释过则直接返回，防止层层重复
    if s:find("无法建立到 API", 1, true) or s:find("请换网络", 1, true) then
        return s
    end
    if s:find("ConnectFail", 1, true) or s:lower():find("connectfail", 1, true) then
        return "ConnectFail：执行器连不上 openrouter.ai（网络限制/无代理）。换网络、开系统代理，或换能出站的执行器后再试。"
    end
    if s:find("Trust", 1, true) or s:find("Http requests are not enabled", 1, true) then
        return "HTTP 未启用或被拦截。"
    end
    if s:find("Timed out", 1, true) or s:lower():find("timeout", 1, true) then
        return "请求超时，网络过慢或目标不可达。"
    end
    return s
end

-- 执行一次 HTTP POST：依次尝试多种 request 实现 + RequestAsync
local function wasaiHttpPost(url, headers, body)
    local lastErr = "no http request function available"
    for _, item in ipairs(wasaiListHttpRequestFns()) do
        local ok, resp = pcall(item.fn, {
            Url = url,
            Method = "POST",
            Headers = headers,
            Body = body,
        ...
        if ok and type(resp) == "table" then
            ...
            local b = resp.Body or resp.body or ""
            local msg = resp.StatusMessage or resp.statusMessage or item.name
            return true, code, b, tostring(msg)
        end
        lastErr = wasaiExplainNetErr(resp)
        -- ConnectFail 时继续试下一个实现，有时不同注入权限不同
    end
    -- 兜底：HttpService:RequestAsync（部分环境仅此可用）
    if svc.HttpService and svc.HttpService.RequestAsync then
        ...
        if ok and type(resp) == "table" then
            return true, resp.StatusCode or 200, resp.Body or "", resp.StatusMessage or "RequestAsync"
        end
        lastErr = wasaiExplainNetErr(resp)
    end
    return false, 0, lastErr, "request error"
end

-- 启动时静默探测：能否访问 OpenRouter（仅日志，不弹窗）
task.spawn(function()
    task.wait(2)
    local probeUrl = "https://openrouter.ai/api/v1/models"
    local okGet, body = pcall(function()
        return game:HttpGet(probeUrl)
    end)
    if okGet and type(body) == "string" and #body > 20 then
        print("[DeltaUI][AI] 网络探测: HttpGet openrouter.ai 成功")
    else
        warn("[DeltaUI][AI] 网络探测: 无法 HttpGet openrouter.ai → " .. wasaiExplainNetErr(body))
        warn("[DeltaUI][AI] 这通常不是 API Key 问题，而是执行器/网络无法访问该域名")
    end
end)
...
local function wasaiDeepSeekChat(messages, tools, opts)
    ...
    -- 仅 DeepSeek 官方 endpoint 才附加 thinking 字段（OpenRouter 等会报错）
    local ep = tostring(wasaiLocalAIConfig.endpoint or "")
    if wasaiLocalAIConfig.thinkingDisabled and ep:find("deepseek", 1, true) then
    ...
    local headers = {
        ...
        -- OpenRouter 建议头（无也不影响多数情况）
        ["HTTP-Referer"] = "https://delta-ui-personal.local",
        ["X-Title"] = "DeltaUI-Personal",
    }
    ...
    if not ok then
        return nil, nil, wasaiExplainNetErr(respBody or statusMsg)
    end
...
local function wasaiCallLLM(messages)
    ...
    if content and content ~= "" then
        ...
        local _ae = tostring(apiErr or "")
        if _ae:find("ConnectFail", 1, true) or _ae:find("连不上", 1, true) then
            answer = "连不上 AI 服务器（ConnectFail）。不是 Key 问题，是当前执行器/网络访问不了 openrouter.ai。请换网络或开代理后再试。"
        else
            answer = "AI 请求失败：" .. _ae
        end
    end
...
local function wasaiLooksIntermediate(content)
    ...
    -- 有代码块 / 较长正文 → 视为最终回答，绝不吞掉
    if content:find("```", 1, true) or content:find("##", 1, true) then return false end
    if #content >= 120 then return false end
    if content:find("local ", 1, true) or content:find("function ", 1, true) then return false end
    -- 仅短句确认语才继续下一轮
    local markers = {
        "我已了解", "正在尝试", "让我先", "让我来", "好的，我来", "好的，我先",
        "开始处理", "我正在", "正在为你", "让我看看", "让我搜索", "让我查找",
        "让我查看", "让我检查", "让我分析", "让我读取", "我需要先", "稍等",
    }
    for _, m in ipairs(markers) do
        if content:find(m, 1, true) then return true end
    end
    if #content < 30 and (content:sub(-1) == ":" or content:sub(-1) == "：") then
        return true
    end
    return false
end
...
local function wasaiGenerateResponseCore(input)
    ...
    for iter = 1, maxIter do
        ...
        if toolCalls and #toolCalls > 0 then
            ...
            if wasaiLooksIntermediate(content) then
                ...
                finalAnswer = (content and content ~= "") and content or "我这一轮没有生成有效内容。请把完整报错或需求再发一次，我会直接给出可运行的代码。"
                break
            end
        end
    end
    ...
    if apiFailed then
        ...
        warn("[DeltaUI][AI] API 调用失败: " .. tostring(apiError))
        wasaiLocalAIState.lastError = apiError
        wasaiLocalAIState.failures = (wasaiLocalAIState.failures or 0) + 1
        wasaiLocalAIState.mode = "local"
        local _ae2 = tostring(apiError or "")
        if _ae2:find("ConnectFail", 1, true) or _ae2:find("连不上", 1, true) then
            finalAnswer = "连不上 AI 服务器（ConnectFail）。不是 Key 问题，是当前执行器/网络访问不了 openrouter.ai。请换网络或开代理后再试。"
        else
            finalAnswer = "AI 请求失败：" .. _ae2
        end
    ...
    elseif not finalAnswer then
        ...
        elseif toolCount > 0 then
            ...
            finalAnswer = "模型没有返回最终说明。请再描述一次问题（附上报错全文），我会给出完整修复代码。"
        end
    ...
    wasaiLocalAIState.available = true
    wasaiLocalAIState.lastLatency = math.max(0, tick() - started)
    table.insert(steps, {phase = "generate", output = "API 生成回复（共调用 " .. toolCount .. " 次工具，模式: " .. wasaiLocalAIState.mode .. "）"})
...
-- 消息气泡容器（必须在 wasaiAddMessage 之前定义）
wasaiCreateMessageContainer = function(text, isUser, customBubbleColor)
...
function wasaiAddMessage(text, isUser, stats)
    if type(wasaiCreateMessageContainer) ~= "function" then
        warn("[DeltaUI][AI] wasaiCreateMessageContainer 未就绪")
        return
    end
    if type(wasaiMessageFrame) ~= "userdata" and type(wasaiMessageFrame) ~= "table" or not wasaiMessageFrame then
        warn("[DeltaUI][AI] wasaiMessageFrame 未就绪")
        return
    end
    local okC, container, bubble = pcall(wasaiCreateMessageContainer, text, isUser)
    if not okC then
        warn("[DeltaUI][AI] 创建消息气泡失败: " .. tostring(container))
        return
    end
    if not container or not bubble then
        warn("[DeltaUI][AI] 消息气泡返回空")
        return
    end
    ...
    -- AI 文字气泡右上角：复制本条（解析失败时也能复制）
    if not isUser then
        local copyOne = create("TextButton", {
            AnchorPoint = Vector2.new(1, 0),
        ...
        corner(4, copyOne)
        copyOne.MouseButton1Click:Connect(function()
            ...
            if ok then
                copyOne.Text = "OK"
                pcall(function() ShowNotification("已复制", 1) end)
                task.delay(1, function() if copyOne and copyOne.Parent then copyOne.Text = "复制" end end)
            else
                pcall(function() ShowNotification("复制失败", 1.5) end)
            end
        end)
...
local scriptbloxGrid = create("UIGridLayout", {CellSize = UDim2.new(0, 365, 0, 120), CellPadding = UDim2.new(0, 10, 0, 10), SortOrder = Enum.SortOrder.LayoutOrder, HorizontalAlignment = Enum.HorizontalAlignment.Left, VerticalAlignment = Enum.VerticalAlignment.Top, FillDirection = Enum.FillDirection.Horizontal})
...
local _scriptbloxLastStatus = nil -- "ok" | "maintenance" | "network" | "empty"

local function getScriptSearchSource()
    local src = _G.__DeltaUI_scriptSearchSource
    if type(src) ~= "string" or src == "" then
        local ok, cfg = pcall(function() return loadConfig() end)
        if ok and type(cfg) == "table" and type(cfg.scriptSearchSource) == "string" then
            src = cfg.scriptSearchSource
        end
    end
    if src == "rscripts" then return "rscripts" end
    return "scriptblox"
end
_G.__DeltaUI_scriptSearchSource = getScriptSearchSource()

local function getScriptSort()
    local s = _G.__DeltaUI_scriptSort
    if type(s) ~= "string" or s == "" then
        local ok, cfg = pcall(function() return loadConfig() end)
        if ok and type(cfg) == "table" and type(cfg.scriptSort) == "string" then
            s = cfg.scriptSort
        end
    end
    return s or "views_desc"
end
_G.__DeltaUI_scriptSort = getScriptSort()

local function scriptSortParams()
    local s = getScriptSort()
    -- ScriptBlox: sortBy + order
    -- RScripts: orderBy + sort
    if s == "views_asc" then
        return { sbSortBy = "views", sbOrder = "asc", rsOrderBy = "views", rsSort = "asc" }
    elseif s == "date_desc" then
        return { sbSortBy = "createdAt", sbOrder = "desc", rsOrderBy = "date", rsSort = "desc" }
    elseif s == "date_asc" then
        return { sbSortBy = "createdAt", sbOrder = "asc", rsOrderBy = "date", rsSort = "asc" }
    elseif s == "likes_desc" then
        return { sbSortBy = "likeCount", sbOrder = "desc", rsOrderBy = "likes", rsSort = "desc" }
    end
    return { sbSortBy = "views", sbOrder = "desc", rsOrderBy = "views", rsSort = "desc" }
end

local function sortScriptListInPlace(list)
    if type(list) ~= "table" or #list == 0 then return list end
    local mode = getScriptSort()
    local function dateKey(item)
        local s = tostring(item.createdAt or item.updatedAt or item.created or "")
        return s
    end
    table.sort(list, function(a, b)
        if type(a) ~= "table" or type(b) ~= "table" then return false end
        if mode == "views_asc" then
            return (tonumber(a.views) or 0) < (tonumber(b.views) or 0)
        elseif mode == "date_desc" then
            return dateKey(a) > dateKey(b)
        elseif mode == "date_asc" then
            return dateKey(a) < dateKey(b)
        elseif mode == "likes_desc" then
            local la = tonumber(a.likeCount or a.likes or a.executes) or 0
            local lb = tonumber(b.likeCount or b.likes or b.executes) or 0
            return la > lb
        end
        -- views_desc default
        return (tonumber(a.views) or 0) > (tonumber(b.views) or 0)
...
-- 统一成 ScriptBlox 卡片同款字段
local function normalizeRScriptsItem(item)
    if type(item) ~= "table" then return nil end
    local gameName = nil
    if type(item.game) == "table" then
        gameName = item.game.title or item.game.name
    end
    local id = item._id or item.id
    local img = item.image or item.imageUrl or item.thumbnail
    if (not img or img == "") and type(item.game) == "table" then
        img = item.game.imgurl or item.game.imageUrl or item.game.gameLogo
    end
    return {
        _id = id,
        title = item.title or "Untitled",
        views = item.views or 0,
        likeCount = item.likes or item.likeCount,
        likes = item.likes,
        executes = item.downloads or item.executes or item.downloadCount,
        key = item.keySystem == true or item.key == true,
        verified = (type(item.user) == "table" and item.user.verified == true) or item.verified == true,
        createdAt = item.createdAt or item.lastUpdated,
        updatedAt = item.lastUpdated or item.updatedAt,
        scriptType = (item.paid and "paid") or (item.keySystem and "key") or "free",
        game = {
            name = gameName or "Universal Script",
            imageUrl = (type(item.game) == "table" and (item.game.imgurl or item.game.imageUrl)) or nil,
            placeId = (type(item.game) == "table" and (item.game.placeId or item.game.PlaceId)) or nil,
        },
        image = img,
...
local function scriptbloxHttpGet(url)
    local raw = nil
...
local function scriptbloxParseScripts(raw)
    if not raw or raw == "" then
    ...
    if msg:lower():find("maintenance", 1, true) or msg:find("维护") then
        return nil, "maintenance", nil
    end
    local meta = { totalPages = 1, currentPage = 1, hasMore = false }
    if data.result and type(data.result.scripts) == "table" then
        meta.totalPages = tonumber(data.result.totalPages) or 1
        meta.currentPage = tonumber(data.result.page or data.result.currentPage) or 1
        meta.hasMore = meta.currentPage < meta.totalPages
        return data.result.scripts, "ok", meta
    end
    if type(data.scripts) == "table" then
        local info = data.info or {}
        meta.totalPages = tonumber(info.maxPages or info.totalPages) or 1
        meta.currentPage = tonumber(info.currentPage or info.page) or 1
        meta.hasMore = meta.currentPage < meta.totalPages
        return data.scripts, "ok", meta
    end
    return nil, "empty", nil
end

local function scriptbloxFilterLocal(list, query)
    if not query or query == "" or not list then
        return list
    end
    ...
    for _, item in ipairs(list) do
        if type(item) == "table" then
            ...
            local gname = ""
            if type(item.game) == "table" then
                gname = string.lower(tostring(item.game.name or ""))
            end
            local slug = string.lower(tostring(item.slug or ""))
            if title:find(q, 1, true) or gname:find(q, 1, true) or slug:find(q, 1, true) then
                out[#out + 1] = item
            end
        end
    end
...
function fetchRScriptsList(searchQuery, page)
    local HttpService = svc.HttpService
    _scriptbloxLastStatus = nil
    searchQuery = tostring(searchQuery or "")
    page = math.max(1, tonumber(page) or 1)

    local function encodeQ(s)
        local okEnc, enc = pcall(function() return HttpService:UrlEncode(s) end)
        if okEnc and enc then return enc end
        return (s:gsub(" ", "+"))
    end

    local sp = scriptSortParams()
    local url
    if searchQuery ~= "" then
        url = "https://rscripts.net/api/v2/scripts?page=" .. page .. "&orderBy=" .. sp.rsOrderBy .. "&sort=" .. sp.rsSort .. "&q=" .. encodeQ(searchQuery)
    else
        url = "https://rscripts.net/api/v2/scripts?page=" .. page .. "&orderBy=" .. sp.rsOrderBy .. "&sort=" .. sp.rsSort
    end

    local raw = scriptbloxHttpGet(url)
    if (not raw or raw == "") and searchQuery == "" and page == 1 then
        raw = scriptbloxHttpGet("https://rscripts.net/api/v2/trending")
    end
    if not raw or raw == "" then
        _scriptbloxLastStatus = "network"
        return nil, false
    end
    ...
    local list = data.scripts
    local hasMore = false
    if type(data.info) == "table" then
        local cur = tonumber(data.info.currentPage) or page
        local maxp = tonumber(data.info.maxPages) or cur
        hasMore = cur < maxp
    end
    if type(list) ~= "table" and type(data.success) == "table" then
        list = {}
        for _, row in ipairs(data.success) do
            if type(row) == "table" then
                local s = row.script or row
                if type(s) == "table" then
                    if row.views and not s.views then s.views = row.views end
                    list[#list + 1] = s
                end
            end
        end
        hasMore = false -- trending 无分页
    end
    if type(list) ~= "table" then
        _scriptbloxLastStatus = "empty"
        return {}, false
    end

    local out = {}
    for _, item in ipairs(list) do
        local n = normalizeRScriptsItem(item)
        if n and n._id and n.title and n.title ~= "" then
            out[#out + 1] = n
        end
    end
    -- 若 info 未给 maxPages：本页满额则认为可能还有下一页
    if not hasMore and #out >= 12 and type(data.info) ~= "table" then
        hasMore = true
    end
    _scriptbloxLastStatus = (#out > 0) and "ok" or "empty"
    return sortScriptListInPlace(out), hasMore
end


function fetchScriptBloxScripts(searchQuery, page)
    page = math.max(1, tonumber(page) or 1)
    if getScriptSearchSource() == "rscripts" then
        return fetchRScriptsList(searchQuery, page)
    end
    local HttpService = svc.HttpService
    _scriptbloxLastStatus = nil
    searchQuery = tostring(searchQuery or "")
    ...
    if searchQuery ~= "" then
        local sp = scriptSortParams()
        local url = "https://scriptblox.com/api/script/search?max=20&page=" .. page
            .. "&sortBy=" .. sp.sbSortBy .. "&order=" .. sp.sbOrder .. "&strict=false&q=" .. encodeQ(searchQuery)
        local scripts, status, meta = scriptbloxParseScripts(scriptbloxHttpGet(url))
        if scripts and #scripts > 0 then
            _scriptbloxLastStatus = "ok"
            local hasMore = meta and meta.hasMore
            if hasMore == nil then hasMore = #scripts >= 20 end
            return sortScriptListInPlace(scripts), hasMore
        end
        if status == "maintenance" then
            _scriptbloxLastStatus = "maintenance"
    ...
    local trendScripts, trendStatus = scriptbloxParseScripts(scriptbloxHttpGet("https://scriptblox.com/api/script/trending"))
    if (not trendScripts or #trendScripts == 0) then
        trendScripts, trendStatus = scriptbloxParseScripts(scriptbloxHttpGet("https://scriptblox.com/api/script/trending?max=20"))
    end
    if trendScripts and #trendScripts > 0 then
        if searchQuery ~= "" then
            local filtered = scriptbloxFilterLocal(trendScripts, searchQuery)
            if filtered and #filtered > 0 then
                _scriptbloxLastStatus = _scriptbloxLastStatus or "ok"
                return sortScriptListInPlace(filtered), false
            end
            if not _scriptbloxLastStatus then
                _scriptbloxLastStatus = "empty"
            end
            return {}, false
        end
        _scriptbloxLastStatus = "ok"
        return sortScriptListInPlace(trendScripts), false
    end

    if not _scriptbloxLastStatus then
        _scriptbloxLastStatus = (trendStatus == "network" and "network") or "empty"
    end
    return nil, false
end

function fetchScriptBloxRaw(scriptId, scriptData)
    -- RScripts：优先用条目里的 rawScript 直链
    if type(scriptData) == "table" and type(scriptData.rawScript) == "string" and scriptData.rawScript ~= "" then
        local raw = scriptbloxHttpGet(scriptData.rawScript)
        if raw and raw ~= "" then return raw end
    end
    if type(scriptbloxSelectedScript) == "table" and type(scriptbloxSelectedScript.rawScript) == "string"
        and tostring(scriptbloxSelectedScript._id) == tostring(scriptId) then
        local raw = scriptbloxHttpGet(scriptbloxSelectedScript.rawScript)
        if raw and raw ~= "" then return raw end
    end
    -- RScripts 详情接口兜底
    if getScriptSearchSource() == "rscripts" or (type(scriptData) == "table" and scriptData._source == "rscripts") then
        local detail = scriptbloxHttpGet("https://rscripts.net/api/v2/script?id=" .. tostring(scriptId))
        if detail and detail ~= "" then
            local ok, data = pcall(function() return svc.HttpService:JSONDecode(detail) end)
            if ok and type(data) == "table" then
                local s = data.script or data.success or data
                if type(s) == "table" then
                    if type(s[1]) == "table" then s = s[1] end
                    if type(s.rawScript) == "string" and s.rawScript ~= "" then
                        local raw = scriptbloxHttpGet(s.rawScript)
                        if raw and raw ~= "" then return raw end
                    end
                    if type(s.script) == "string" and s.script ~= "" then
                        return s.script
                    end
                end
            end
...
makeScriptBloxOptionBtn(t("execute_selected"), "play", theme.accent, 85, function()
    ...
    local raw = fetchScriptBloxRaw(scriptbloxSelectedScript._id, scriptbloxSelectedScript)
    if raw and raw ~= "" then
        cleanupOldUI()
...
function makeScriptBloxCard(scriptData, layoutOrder)
    ...
    local thumbWrap = create("Frame", {
        ...
        BackgroundColor3 = theme.surfaceLight or Color3.fromRGB(40, 42, 55),
        BackgroundTransparency = 0.15,
        BorderSizePixel = 0,
        ZIndex = 5,
        ClipsDescendants = true,
    ...
    local function resolveImageUrl(data)
        if type(data) ~= "table" then return nil end
        local candidates = {
            data.image,
            data.imageUrl,
            data.thumbnail,
            data.game and data.game.imageUrl,
            data.game and data.game.imgurl,
        ...
        for _, u in ipairs(candidates) do
            if type(u) == "string" and u ~= "" then
                ...
                if u:sub(1, 1) == "/" then
                    if data._source == "rscripts" then
                        return "https://rscripts.net" .. u
                    end
                    return "https://scriptblox.com" .. u
                end
                if u:find("^https?://") or u:find("^rbx") then
                    return u
                end
            end
        end
        -- 有 placeId 时用 Roblox 官方缩略图（执行器里更稳）
        local placeId = nil
        if type(data.game) == "table" then
            placeId = data.game.placeId or data.game.PlaceId or data.game.id
        end
        placeId = placeId or data.placeId
        if placeId and tostring(placeId):match("^%d+$") then
            return "rbxthumb://type=GameIcon&id=" .. tostring(placeId) .. "&w=150&h=150"
        end
        return nil
    end

    local imgUrl = resolveImageUrl(scriptData)
    ...
    local placeholder = create("TextLabel", {
        Name = "Placeholder",
        Size = UDim2.new(1, 0, 1, 0),
        BackgroundColor3 = Color3.fromRGB(55, 58, 78),
        BackgroundTransparency = 0,
        BorderSizePixel = 0,
        Text = string.upper(string.sub(tostring(scriptData.title or "?"), 1, 1)),
        TextColor3 = Color3.fromRGB(180, 185, 210),
        TextSize = 36,
        Font = Enum.Font.SourceSansBold,
        ZIndex = 5,
    })
    placeholder.Parent = thumbWrap

    if imgUrl then
        task.spawn(function()
            local finalUrl = imgUrl
            -- http(s) 图：下载到本地再用 getcustomasset（和扩展包同一套逻辑）
            if imgUrl:find("^https?://") and type(getCachedIcon) == "function" then
                local cached = getCachedIcon(imgUrl, tostring(scriptData._id or scriptData.title or "script"))
                if cached and cached ~= "" then
                    finalUrl = cached
                end
            end
            if thumb and thumb.Parent then
                thumb.Image = finalUrl
    ...
    local needsKey = scriptData.key == true or scriptData.key == 1 or scriptData.key == "true"
    local badgeY = 8
    local function addBadge(text, bg)
        local w = math.clamp(#tostring(text) * 7 + 14, 44, 72)
        local badge = create("Frame", {
            AnchorPoint = Vector2.new(1, 0),
            Position = UDim2.new(1, -10, 0, badgeY),
            Size = UDim2.new(0, w, 0, 18),
            BackgroundColor3 = bg,
            BackgroundTransparency = 0.15,
            BorderSizePixel = 0,
            ZIndex = 8,
    ...
    if needsKey then
        addBadge(t("key_required"), Color3.fromRGB(200, 70, 70))
    else
        addBadge(t("key_free"), Color3.fromRGB(40, 140, 90))
    end
    if scriptData.verified then
        addBadge(t("verified_badge"), theme.accent)
    end

    local titleLabel = create("TextLabel", {
        Position = UDim2.new(0, contentX, 0, 8),
        Size = UDim2.new(1, -(contentX + 78), 0, 22),
        BackgroundTransparency = 1,
    ...
    if string.find(string.lower(tostring(gameNameRaw)), "universal") then
        gameName = t("universal_script")
    end
    local gameLabel = create("TextLabel", {
        Position = UDim2.new(0, contentX, 0, 32),
        Size = UDim2.new(1, -(contentX + 16), 0, 16),
        BackgroundTransparency = 1,
        Text = gameName,
        TextColor3 = theme.textDim,
        TextSize = 11,
    ...
    local views = scriptData.views or scriptData.viewCount or 0
    local likes = scriptData.likeCount or scriptData.likes
    local executes = scriptData.executes or scriptData.executeCount
    local dateStr = fmtDate(scriptData.createdAt or scriptData.created or scriptData.updatedAt)
    local metaLine = t("published_label") .. " " .. dateStr .. "  ·  " .. fmtNum(views) .. " " .. t("views_label")
    if executes ~= nil then
        metaLine = metaLine .. "  ·  " .. fmtNum(executes) .. " " .. t("executes_label")
    elseif likes ~= nil then
        metaLine = metaLine .. "  ·  " .. fmtNum(likes) .. " " .. t("likes_label")
    end

    local metaLabel = create("TextLabel", {
        Position = UDim2.new(0, contentX, 0, 52),
        Size = UDim2.new(1, -(contentX + 16), 0, 32),
        BackgroundTransparency = 1,
        Text = metaLine,
        TextColor3 = theme.textDim,
        TextSize = 11,
...
local _scriptListPage = 1
local _scriptListHasMore = false
local _scriptListFilter = ""
local _scriptListLoading = false
local _scriptListCardCount = 0

local function removeScriptLoadMoreBtn()
    if not scriptbloxScroll then return end
    local old = scriptbloxScroll:FindFirstChild("LoadMoreBtn")
    if old then old:Destroy() end
end

local function appendScriptCards(scripts)
    if type(scripts) ~= "table" then return 0 end
    local added = 0
    for _, scriptData in ipairs(scripts) do
        if scriptData and type(scriptData) == "table"
            and scriptData.title and tostring(scriptData.title) ~= ""
            and scriptData._id and tostring(scriptData._id) ~= "" then
            _scriptListCardCount = _scriptListCardCount + 1
            added = added + 1
            local card = makeScriptBloxCard(scriptData, _scriptListCardCount)
...
local function updateScriptLoadMoreBtn()
    removeScriptLoadMoreBtn()
    if not _scriptListHasMore or not scriptbloxScroll then return end
    local btn = create("TextButton", {
        ...
        BackgroundTransparency = 0.25,
        BorderSizePixel = 0,
        Text = t("load_more_scripts"),
        TextColor3 = Color3.fromRGB(255, 255, 255),
        TextSize = 14,
        Font = Enum.Font.SourceSansBold,
        LayoutOrder = 99999,
        ZIndex = 5,
        Parent = scriptbloxScroll,
    })
    corner(10, btn)
    btn.MouseButton1Click:Connect(function()
        if _scriptListLoading or not _scriptListHasMore then return end
        _scriptListLoading = true
        btn.Text = t("loading_more")
        btn.Active = false
        task.spawn(function()
            local nextPage = _scriptListPage + 1
            local scripts, hasMore = fetchScriptBloxScripts(_scriptListFilter, nextPage)
            if type(scripts) == "table" then
                sortScriptListInPlace(scripts)
            end
            local added = appendScriptCards(scripts)
            if added > 0 then
                _scriptListPage = nextPage
                _scriptListHasMore = hasMore and true or false
            else
                _scriptListHasMore = false
            end
            _scriptListLoading = false
            ...
            updateScriptLoadMoreBtn()
            if added == 0 then
                pcall(function() ShowNotification(t("no_more_scripts"), 1.5) end)
            end
        end)
    end)
    if scriptbloxScroll and scriptbloxGrid then
...
function refreshScriptBloxList(filter)
    filter = filter or ""
    _scriptListFilter = filter
    _scriptListPage = 1
    _scriptListHasMore = false
    _scriptListLoading = false
    _scriptListCardCount = 0
    ...
    local scripts, hasMore = fetchScriptBloxScripts(filter, 1)
    if type(scripts) == "table" then
        sortScriptListInPlace(scripts)
    end
    _scriptListHasMore = hasMore and true or false
    ...
    if not scripts or #scripts == 0 then
        local tip = t("scriptblox_no_results")
        if _scriptbloxLastStatus == "maintenance" then
            tip = t("scriptblox_maintenance")
        elseif _scriptbloxLastStatus == "network" then
            tip = t("scriptblox_network_fail")
        end
    ...
    if _scriptbloxLastStatus == "maintenance" then
        local tip = create("TextLabel", {
            ...
            BackgroundTransparency = 1,
            Text = t("scriptblox_maintenance"),
            TextColor3 = theme.warn or Color3.fromRGB(250, 200, 80),
            TextSize = 12,
            Font = Enum.Font.SourceSansBold,
            TextXAlignment = Enum.TextXAlignment.Left,
            ZIndex = 4,
        ...
        tip.Parent = scriptbloxScroll
    end
    appendScriptCards(scripts)
    if _scriptListCardCount == 0 then
...
wasaiShowScriptResult = function(title, source)
    ...
    local function makeHeadBtn(text, xOffset, bg)
        local btn = create("TextButton", {
            AnchorPoint = Vector2.new(1, 0.5),
            Position = UDim2.new(1, xOffset, 0.5, 0),
            Size = UDim2.new(0, 52, 0, 22),
            BackgroundColor3 = bg or theme.accent,
            BackgroundTransparency = 0.2,
            BorderSizePixel = 0,
            Text = "",
            AutoButtonColor = true,
    ...
    -- 右到左：执行 / 复制 / 编辑
    local execBtn, execTxt = makeHeadBtn("执行", -8, Color3.fromRGB(34, 160, 90))
    local copyBtn, copyTxt = makeHeadBtn("复制", -64, theme.accent)
    local editBtn, editTxt = makeHeadBtn("编辑", -120, Color3.fromRGB(70, 90, 130))

    local codeScroll = create("ScrollingFrame", {
        Position = UDim2.new(0, 0, 0, 34),
        Size = UDim2.new(1, 0, 0, math.clamp(12 * (select(2, source:gsub("\n", "\n")) + 1) + 24, 80, 280)),
        BackgroundTransparency = 1,
        BorderSizePixel = 0,
        ScrollBarThickness = 4,
        ScrollBarImageColor3 = theme.textDim,
    ...
    local codeLabel = create("TextLabel", {
        ...
        BackgroundTransparency = 1,
        RichText = true,
        Text = (type(syntaxHighlight) == "function" and syntaxHighlight(source)) or source,
    ...
    local function wasaiCopyText(txt)
        txt = tostring(txt or "")
        ...
        if type(Clipboard) == "table" and type(Clipboard.set) == "function" then
            local ok = pcall(Clipboard.set, txt)
            if ok then return true, "clipboard" end
        end
        -- 兜底写入文件
        if type(writefile) == "function" then
            pcall(function()
                if isfolder and not isfolder("DeltaUI") then makefolder("DeltaUI") end
                writefile("DeltaUI/last_ai_code.lua", txt)
            end)
            return true, "file"
        end
        return false, "none"
    ...
    copyBtn.MouseButton1Click:Connect(function()
        local ok, how = wasaiCopyText(source)
        if ok and how == "clipboard" then
            copyTxt.Text = "已复制"
            pcall(function() ShowNotification("代码已复制到剪贴板", 1.5) end)
            task.delay(1.5, function() if copyTxt and copyTxt.Parent then copyTxt.Text = "复制" end end)
        elseif ok and how == "file" then
            copyTxt.Text = "已存盘"
            pcall(function() ShowNotification("无剪贴板，已保存到 DeltaUI/last_ai_code.lua", 2.5) end)
            task.delay(2, function() if copyTxt and copyTxt.Parent then copyTxt.Text = "复制" end end)
        else
            copyTxt.Text = "失败"
            pcall(function() ShowNotification("复制失败：执行器无剪贴板 API", 2) end)
            task.delay(1.5, function() if copyTxt and copyTxt.Parent then copyTxt.Text = "复制" end end)
        end
    end)
    ...
    execBtn.MouseButton1Click:Connect(function()
        ...
        task.spawn(function()
            local cfg = loadConfig and loadConfig() or {}
            if not cfg.autoAcceptExec and type(wasaiShowConfirmDialog) == "function" then
                if not wasaiShowConfirmDialog(source) then
                    execTxt.Text = "取消"
                    task.delay(1.2, function() if execTxt and execTxt.Parent then execTxt.Text = "执行" end end)
                    return
                end
            end
            local execFn = rawget(_G, "__DeltaUI_wasaiExecuteLuaCode")
            if type(execFn) ~= "function" then
                pcall(function() execFn = getgenv().__DeltaUI_wasaiExecuteLuaCode end)
            end
            if type(execFn) ~= "function" and type(wasaiExecuteLuaCode) == "function" then
                execFn = wasaiExecuteLuaCode
            end
            if type(execFn) ~= "function" then
                -- 最终兜底：直接 loadstring
                execFn = function(code)
                    local fn, e = loadstring(code)
                    if not fn then return nil, e end
                    local ok, res = pcall(fn)
                    if not ok then return nil, res end
                    return tostring(res or ""), nil
                end
            end
            local out, err = execFn(source)
            if out then
                execTxt.Text = "成功"
                pcall(function() ShowNotification("执行成功", 1.5) end)
                if type(wasaiAddMessage) == "function" then
                    local msg = (out ~= "" and ("执行输出:\n" .. tostring(out))) or "执行成功（无输出）"
                    pcall(wasaiAddMessage, msg, false)
                end
            else
                execTxt.Text = "失败"
                pcall(function() ShowNotification("执行失败: " .. tostring(err), 3) end)
                if type(wasaiAddMessage) == "function" then
                    pcall(wasaiAddMessage, "执行失败: " .. tostring(err), false)
                end
            end
            task.delay(1.5, function() if execTxt and execTxt.Parent then execTxt.Text = "执行" end end)
        end)
    end)
    ...
    editBtn.MouseButton1Click:Connect(function()
        ...
        pcall(function()
            ...
            if type(switchPage) == "function" then
                switchPage("house")
            elseif type(switchPage) == "function" then
                switchPage("terminal")
            end
            -- 常见编辑页名
            if pages then
                if pages["house"] and type(switchPage) == "function" then switchPage("house") end
            end
            editTxt.Text = "已填入"
            ShowNotification("代码已填入编辑器", 1.5)
            task.delay(1.5, function() if editTxt and editTxt.Parent then editTxt.Text = "编辑" end end)
        end)
    end)
...
-- 解析 AI 回复中的代码块：支持 Markdown ```lua ... ``` / ``` ... ``` 以及旧版 ##代码##
-- 有代码块时分段渲染（文字气泡 + 可复制/执行的代码卡片）
wasaiRenderMessageWithCode = function(reply, stats)
    ...
    local function pushText(s)
        ...
        -- 丢掉单独的 ## 行
        s = s:gsub("^##%s*$", ""):gsub("\n##%s*\n", "\n"):gsub("\n##%s*$", "")
        if s ~= "" then parts[#parts + 1] = {type = "text", text = s} end
    end
    local function pushCode(s)
        ...
        if s ~= "" then
            hasCode = true
            parts[#parts + 1] = {type = "code", text = s}
        end
    end

    while pos <= n do
        -- 优先找 Markdown 代码围栏 ``` 或 ```lang
        local fs, fe = reply:find("```", pos, true)
        -- 单独的 ## 不当代码边界（很多模型会乱输出一个 ##）
        if fs then
            pushText(reply:sub(pos, fs - 1))
            -- 解析语言标签
            local after = reply:sub(fe + 1, fe + 20)
            local langEnd = after:find("\n", 1, true)
            local contentStart
            if langEnd then
                local langLine = after:sub(1, langEnd - 1)
                if langLine:match("^[%w%+%-%_]*$") then
                    contentStart = fe + langEnd + 1
                else
                    contentStart = fe + 1
                end
            else
            ...
            local close = reply:find("```", contentStart, true)
            if close then
                pushCode(reply:sub(contentStart, close - 1))
                pos = close + 3
                -- 吃掉收尾换行
                if reply:sub(pos, pos) == "\n" then pos = pos + 1 end
            else
                -- 未闭合：从这里到结尾都当代码
                pushCode(reply:sub(contentStart))
                pos = n + 1
            end
        else
            -- 无 fence：尝试旧 ##code## 成对格式
            local hs = reply:find("##", pos, true)
            if hs then
                local hs2 = reply:find("##", hs + 2, true)
                if hs2 and (hs2 - hs) > 4 then
                    local mid = reply:sub(hs + 2, hs2 - 1)
                    -- 中间像代码才当代码
                    if mid:find("function", 1, true) or mid:find("local ", 1, true) or mid:find("GetService", 1, true) or mid:find("\n", 1, true) then
                        pushText(reply:sub(pos, hs - 1))
                        pushCode(mid)
                        pos = hs2 + 2
                    else
                        -- 不像代码，跳过这个 ##
                ...
                pushText(reply:sub(pos))
                break
            end
        end
    end

    -- 仍无代码块，但整段像 Lua 脚本时，整段当代码卡
    if not hasCode then
        local plain = reply:gsub("^##%s*", "")
        local look = plain:lower()
        if (look:find("local ", 1, true) or look:find("function ", 1, true))
            and (look:find("getservice", 1, true) or look:find("workspace", 1, true) or look:find("players", 1, true))
            and #plain > 40 then
            -- 前面有中文说明则拆开
            local codeStart = plain:find("local ", 1, true) or plain:find("function ", 1, true) or 1
            local intro = plain:sub(1, codeStart - 1)
            local code = plain:sub(codeStart)
            if intro:match("%S") then
                wasaiAddMessage(intro, false, stats)
            end
            wasaiShowScriptResult("Lua 代码", code)
            return true
        end
        return nil
    end
    ...
    for _, part in ipairs(parts) do
        if part.type == "text" then
            ...
            wasaiShowScriptResult("Lua 代码", part.text)
        end
    end
    return true
end
...
consoleTitle = create("TextLabel", {Position = UDim2.new(0, 12, 0, 0), Size = UDim2.new(1, -200, 1, 0), BackgroundTransparency = 1, Text = t("console"), TextColor3 = theme.textDim, TextSize = 12, Font = Enum.Font.SourceSansBold, TextXAlignment = Enum.TextXAlignment.Left, TextYAlignment = Enum.TextYAlignment.Center, ZIndex = 4})
consoleTitle.Parent = consoleHeader
table.insert(settingsData.uiRefs, {element = consoleTitle, key = "console"})

-- 控制台：复制全部 / 仅复制错误（贴给 AI 用）
local function wasaiCopyConsole(filterErrorsOnly)
    local buf = _G.__DeltaUI_consoleBuffer or {}
    local lines = {}
    for _, item in ipairs(buf) do
        if (not filterErrorsOnly) or item.lvl == "error" then
            lines[#lines + 1] = tostring(item.msg)
        end
    end
    if #lines == 0 then
        -- 兜底：从 UI 扫 TextButton/TextLabel
        if consoleScroll then
            for _, child in ipairs(consoleScroll:GetChildren()) do
                if (child:IsA("TextLabel") or child:IsA("TextButton")) and child.Text and child.Text ~= "" then
                    local isErr = filterErrorsOnly and (child.TextColor3 == theme.red)
                    if (not filterErrorsOnly) or isErr or (child.Text:find("%[Error%]") or child.Text:find("Error") or child.Text:find("错误")) then
                        if not filterErrorsOnly or isErr or child.Text:find("Error") or child.Text:find("错误") or child.Text:find("nil") then
    ...
    if text == "" then
        pcall(function() ShowNotification("没有可复制的日志", 1.5) end)
        return
    end
    local ok = false
    if type(setclipboard) == "function" then ok = pcall(setclipboard, text) end
    if not ok and type(toclipboard) == "function" then ok = pcall(toclipboard, text) end
    if not ok and type(writefile) == "function" then
        pcall(function()
            if isfolder and not isfolder("DeltaUI") then makefolder("DeltaUI") end
            writefile("DeltaUI/console_log.txt", text)
        end)
        pcall(function() ShowNotification("已保存到 DeltaUI/console_log.txt", 2) end)
        return
    end
    if ok then
        pcall(function() ShowNotification(filterErrorsOnly and ("已复制 " .. #lines .. " 条错误") or ("已复制 " .. #lines .. " 条日志"), 1.5) end)
    else
        pcall(function() ShowNotification("复制失败", 1.5) end)
    end
end

local consoleCopyAllBtn = create("TextButton", {
    AnchorPoint = Vector2.new(1, 0.5),
...
corner(6, consoleCopyAllBtn)
consoleCopyAllBtn.Parent = consoleHeader
consoleCopyAllBtn.MouseButton1Click:Connect(function()
    wasaiCopyConsole(false)
end)

local consoleCopyErrBtn = create("TextButton", {
    AnchorPoint = Vector2.new(1, 0.5),
...
corner(6, consoleCopyErrBtn)
consoleCopyErrBtn.Parent = consoleHeader
consoleCopyErrBtn.MouseButton1Click:Connect(function()
    wasaiCopyConsole(true)
end)
...
function refreshCloudList(filter, manageMode)
    ...
    if manageMode then
        ...
        -- 个人精简版：关闭原作者云模块列表（不再请求 WasKKal model.json）
        do
            local tip = create("TextLabel", {
            ...
            tip.Parent = cloudScroll
            AddLog("[Cloud] 个人精简版：已跳过远程 model.json", "info")
            cloudRefreshLock = false
            pendingCloudRefresh = nil
            return
        end
...
_G.__DeltaUI_uninstallModule = uninstallModule
_G.__DeltaUI_makeModuleCard = makeModuleCard
-- wasaiCreateMessageContainer 已上移到 wasai 模块内定义
